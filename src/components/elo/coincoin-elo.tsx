...
/** Facteur K du CoinCoin — peut diverger du FifaChamp à l'avenir */
const K = 40;
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-3">
        <h3 className="font-semibold text-slate-800">Les 4 classements CoinCoin</h3>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4">
            ...
            <p className="mt-1 text-sm text-slate-500">
              ...
              a son propre Elo totalement indépendant des Elos individuels. C&apos;est le classement vedette du CoinCoin.
            </p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-3 text-sm text-slate-600">
            ...
            <p className="text-slate-500">
              Le delta de l&apos;Elo global s&apos;applique{" "}
              <strong>en entier à chaque membre</strong> de l&apos;équipe en 2v2 (pas divisé par deux).
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 rounded-xl border border-slate-100 bg-white p-4">
            ...
            <Var name="400">
              ...
              Même constante que dans le système Elo des échecs, son rôle est de fixer{" "}
              <strong>à combien de points d&apos;écart correspond une vraie différence de force</strong>.
              Plus ce nombre serait élevé, moins les écarts d&apos;Elo pèseraient dans la formule.
            </Var>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 rounded-xl border border-slate-100 bg-white p-4">
            ...
            <Var name={`K = ${K}`}>
              ...
              des gains et des pertes. Plus le facteur K est élevé, plus les points échangés sont
              importants et rendent le classement plus sensible aux surprises.
            </Var>
        ...
        <div className="flex flex-col gap-3">
          <ExampleCard
            ...
            rows={[
              ...
              { label: "Delta (A ou B gagne)", value: `${K} × (1 − 0,5) = ${K / 2}` },
            ]}
            result={{
              winner: `Gagnant : 1000 → ${1000 + K / 2} (+${K / 2})`,
              loser: `Perdant : 1000 → ${1000 - K / 2} (−${K / 2})`,
            }}
          />
          <ExampleCard
